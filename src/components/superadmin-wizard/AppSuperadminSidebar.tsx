...
const steps = [
  ...
  { url: "/superadmin-wizard/assign-employee", label: "Assign Employee", icon: <Briefcase size={18} />, key: "employee" },
...
export default function AppSuperadminSidebar() {
  ...
  // Use mock completedSteps or real from context
  const completedSteps = wizardCtx?.completedSteps || [];
